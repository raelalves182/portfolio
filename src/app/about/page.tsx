    ...
    <section className="bg-hero-pattern bg-no-repeat bg-cover bg-center h-screen">
      <div className="container max-w-6xl p-6 m-auto h-full flex justify-center">
        <div className="flex items-center flex-wrap md:flex-nowrap gap-6 bg-black bg-opacity-75 m-auto rounded">
          ...
          <div className="p-4">
            <h1 className="text-2xl sm:text-3xl text-white font-bold before:content-['━━'] before:text-sky-700 before:text-4xl before:mr-2">
              About me
            </h1>

            <p className="text-base sm:text-2xl text-white">I&apos;m Israel Alves, a <strong>Front-End Developer</strong>, focused and passionate about music and technology.</p>
          </div>
        </div>
      </div>
    </section>
