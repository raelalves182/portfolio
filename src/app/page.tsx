      ...
      <main>
        <section className="bg-hero-pattern bg-no-repeat bg-cover bg-center h-screen">
          <div className="container max-w-6xl px-6 m-auto h-full flex justify-center">
            <div className="max-w-5xl m-auto p-6 sm:p-16 rounded-[32px] bg-black bg-opacity-75 text-center mt-28">
              ...
              <div className="flex items-center justify-center gap-4">
                <Button>
                  <Link
                    ...
                    className="block text-base sm:text-2xl text-[#DDDADC] border px-4 py-2 rounded-full hover:bg-teal-500 transition-all"
                  >
                    Contact
                  </Link>
                </Button>
